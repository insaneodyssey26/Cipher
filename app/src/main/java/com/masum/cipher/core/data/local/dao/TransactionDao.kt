...
interface TransactionDao {
    ...
    @Query("SELECT * FROM transactions WHERE amount = :amount AND isIncome = :isIncome AND timestamp BETWEEN :startTime AND :endTime LIMIT 1")
    suspend fun findDuplicate(amount: Double, isIncome: Boolean, startTime: Long, endTime: Long): TransactionEntity?
